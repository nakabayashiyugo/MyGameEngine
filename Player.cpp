...
void Player::PlayUpdate()
{
	...
	case MATH_WALL:
		...
		case 1:
		case 2:
			transform_.position_ = XMFLOAT3(transform_.position_.x, transform_.position_.y, prevPos.z);
			break;
		case 3:
		case 4:
			transform_.position_ = XMFLOAT3(prevPos.x, transform_.position_.y, transform_.position_.z);
			break;
		}
		wallHitDir_ = 0;
		break;
